...
<div class="box"></div>
<div class="box1">
<h4 class="text-center">Exam Marks</h4>
<form  action="exam-marks.php" method="post" enctype="multipart/form-data">
...
<option value="SemVIII">SemVIII</option>
 ...
 <?php 
             if(isset($_POST['submit'])){
			$temp=0;
			$result=mysql_query("SELECT * FROM enter_marks  where stream='$search1' and sem='$search2'");
			 while($test = mysql_fetch_array($result))
			{
			      $temp=1;
				 $id = $test['student_id'];
  echo"<table border='1' cellpadding='1' cellspacing='1' style='margin-left:100px;'>
  <tr>
  <td>student_id</td>
  <td>stream</td>
  <td>sem</td>
  ...
  <td>marks</td>
      ...
      <tr>
     <td><b>".$test['student_id']."</b></td>
	  <td><b>".$test['stream']."</b></td>
	   <td><b>".$test['sem']."</b></td>
	    <td><b>".$test['subject']."</b></td>
		 <td><b>".$test['marks']."</b></td>
...
if($temp==0)
	echo"
	<tr><td colspan='13' align='center'><font color='black'><center><h4 style='margin-top:20px;'> Exam Marks Not Decleared</h4></center></font></td></tr>";
	echo "</table>";
	 }
    ?>
</div>
