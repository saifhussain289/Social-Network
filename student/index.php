...
<?php
 include('../db/connect.php');
   $uname= $_REQUEST['username'];
	$query = mysql_query("select * from  registration where username = '$uname'");
...
<h4>User Profile</h4><hr>
 <img src="../admin/facultyt_photo/<?php  echo $pic?>" style="width:80%; height:200px; margin:30px; border-radius:50%">
 <p><?php  echo $name?></p>
 <p><?php  echo $mobile?></p>
  <p><i class="far fa-calendar-alt"></i><?php  echo $dob?></p>
  <p><?php  echo $email?></p>
