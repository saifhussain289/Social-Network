...
<form  action="time-table.php" method="post" enctype="multipart/form-data">
...
<option value="SemVIII">SemVIII</option>
 ...
 <?php 
             if(isset($_POST['submit'])){
			$temp=0;
			$result=mysql_query("SELECT * FROM time_table  where stream='$search1' and sem='$search2' limit 1");
  ...
  echo"<table border='0' cellpadding='1' cellspacing='1' style='margin-left:300px;'>
      <tr>
     <td><b><img src='../exam_officer/file/".$test['image']."' style='width:400px; height:500px; margin-left:-80px;'></b></td>
...
if($temp==0)
	echo"
	<tr><td colspan='13' align='center'><font color='black'><center><h4 style='margin-top:20px;'> Time Table Not Decleared</h4></center></font></td></tr>";
	echo "</table>";
	 }
    ?>
</div>
